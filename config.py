...
__C.ASSETS_PATH = '/home/ubuntu/junwang/paper/ICIP/Leaf_Segmentation'
...
__C.DATASET.LEAFVEIN_DIR = 'data/leafvein'
__C.DATASET.HAINAN_LEAF_DIR = 'data/hainan_leaf'
__C.DATASET.BTF_DIR = 'data/btf'
__C.DATASET.STARE_DIR = 'data/stare'
__C.DATASET.DRIVE_DIR = 'data/drive'
__C.DATASET.CITYSCAPES_CUSTOMCOARSE = \
  os.path.join(__C.ASSETS_PATH, 'c/Cityscapes/autolabelled')
...
__C.MODEL.REFINEMENT = True
__C.MODEL.ERROR_ATTN_WEIGHT = 0.5
...
__C.LOSS.OCR_ALPHA = 0.4 # origin 0.4
__C.LOSS.ERR_ATTN_ALPHA = 0.5
